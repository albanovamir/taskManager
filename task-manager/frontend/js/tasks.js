document.addEventListener('DOMContentLoaded', function() {
    ...
    // прошлая функция, без отладки, если что верну
    // Load teams for task creation dropdown
    ...
    //         // Trigger change to load members for the first team
    //         if (teams.length > 0) {
    //             loadTeamMembers(teams[0].id);
    //         }
    //     });
        
    //     // Add change listener to team select
    ...
    // })
    // .then(teams => {
    //     console.log('Received teams:', teams); // Добавьте лог для отладки
    //     const teamSelect = document.getElementById('taskTeam');
    //     teamSelect.innerHTML = '';
        
    //     if (!teams || teams.length === 0) {
    //         console.warn('No teams received or empty array');
    //         return;
    //     }
    ...
    //     console.log('Вот, что передается в функцию: ');
    //     console.log(teams[0].ID);
        
    //     // Загружаем участников первой команды
    //     loadTeamMembers(teams[0].ID);
    // })
    // .catch(error => {
